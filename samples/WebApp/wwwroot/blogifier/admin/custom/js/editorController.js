    ...
    function loadActionButtons() {
        ...
        if (postId === '0') {
            ...
            if (published.indexOf("0001") >= 0) {
                ...
                btn += '<a class="dropdown-item" onclick="editorController.deletePost(); return false;">Delete</a>';
                btn += '</div></div> ';
                btn += '<a href="' + webRoot + "/blog" + postSlug + '" target="_blank" class="btn btn-secondary btn-icon mr-1 float-right" aria-label="View post" title="View" data-placement="bottom"><i class="fa fa-eye"></i></a>';
            }//blogRoute
        }
